# PX-SK-04 Output Template — technical-health-assessment

## 1. Document Metadata

- document_name:
- skill_id: `PX-SK-04`
- skill_name: `technical-health-assessment`
- version:
...
- brownfield_health_judgment:
  ...
  - recommended_next_move:
    - `stop | assess-more | build-safety-net | proceed-technical-refactor | package-partial-change`
