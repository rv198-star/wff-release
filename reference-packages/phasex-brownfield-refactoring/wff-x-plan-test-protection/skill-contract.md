# wff-x-plan-test-protection Skill Contract — plan-test-protection
...
- required:
  ...
  - `wff-x-scan-tech-health` output when available
- optional:
  - existing test suite
...
- safety-net strategy starts from `wff-x-scan-tech-health` risk when available and does not demand a full test suite when a smaller fast feedback loop is the honest first protection
