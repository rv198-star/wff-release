...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| P01 | `<source-defined entry surface>` | `/<entry-route>` | dashboard | `<source-defined primary actor>` | `<source-defined allowed roles>` | `<source-defined starting goal>` | `<source-use-case-id>` | `<source-defined objects>` | `<source-defined context bundle>` | context_header,data_view,work_area,status_feedback,next_steps | `<source-defined entry condition>` | `<source-defined handoff condition>` | `/<next-route>` | show-inline-denied-banner | review-bound | `<source-specific readiness proof required>` | `<source-defined primary action>` | `/<entry-route>` | — |
| P02 | `<source-defined work surface>` | `/<work-route>` | execution-workbench | `<source-defined primary actor>` | `<source-defined allowed roles>` | `<source-defined work goal>` | `<source-use-case-id>` | `<source-defined objects>` | `<source-defined work context>` | context_header,data_view,work_area,status_feedback,next_steps | `<source-defined context selected>` | `<source-defined work outcome recorded>` | `/<review-route>` | hide-primary-action-and-show-denied-hint | review-bound | `<source-specific readiness proof required>` | `<source-defined work action>` | `/<work-route>` | P01 |
| P03 | `<source-defined review surface>` | `/<review-route>` | review-decision | `<source-defined review actor>` | `<source-defined allowed roles>` | `<source-defined review goal>` | `<source-use-case-id>` | `<source-defined objects>` | `<source-defined review context>` | context_header,data_view,work_area,status_feedback,next_steps,audit_strip | `<source-defined work context preserved>` | `<source-defined review outcome recorded>` | — | show-inline-denied-banner | review-bound | `<source-specific readiness proof required>` | `<source-defined review action>` | `/<review-route>` | P02 |
