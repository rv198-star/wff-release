...
| traceability | Stage-02 aggregate/object realization coverage | `pass | fail` | | |
| diagnostic | Schema table count vs Stage-02 aggregate/object count | `pass` | | table-count parity is diagnostic only; every aggregate/object needs explicit realization or deferral |
