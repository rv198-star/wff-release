...
def write_engineering_spec_pack(
    *,
    ...
    sections = [
        ...
        (
            f"- existing-system architecture change intake: `{existing_system_architecture_change_intake.name}`"
            if existing_system_architecture_change_intake
        ...
        render_thesis_driven_architecture_handoff(stage_04_text),
        "",
        ...
        *optional_stage_sections,
        ...
        render_key_decisions_quick_reference(stage_01_text),
        "",
        "## 8. Risk Summary",
