...
MINDTHUS_METHOD_RUNTIME_EXPECTATIONS = (
    ...
    (
        ...
        (r"Scenario Router", r"3l5s", r"wae"),
    ),
    (
...
def main() -> int:
    ...
    kernel_patterns = (
        r"runtime-deps/mindthus/source/skills/3l5s/SKILL\.md",
        r"runtime-deps/mindthus/source/skills/3l5s/resources/three-layer-recursive-loop\.md",
        r"runtime-deps/mindthus/source/skills/using-mindthus/SKILL\.md",
