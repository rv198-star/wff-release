# PX-SK-04 Skill Contract — technical-health-assessment
...
- `risk_to_action_map` turns each material risk into `stop`, `assess-more`, `build-safety-net`, `proceed-technical-refactor`, or `package-partial-change`
