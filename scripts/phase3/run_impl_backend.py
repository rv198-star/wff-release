...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate Phase-3 backend capability artifacts")
    parser.add_argument("--phase2-root", required=True)
    parser.add_argument("--output-dir", required=True)
    parser.add_argument("--title", default="Phase-3 Backend")
...
def main(argv: list[str] | None = None) -> int:
    ...
    summary = scaffold_backend_implementation(
