...
PROFILED_CROSS_PHASE_SURFACES: dict[str, dict[str, str]] = {
    ...
    "phase2": {
        ...
        "p1-to-p2-source-admission-report.json": ".phase2-evidence/p1-to-p2-source-admission-report.json",
        "phase-2-output-contamination-report.json": ".phase2-evidence/phase-2-output-contamination-report.json",
        ...
        "phase2-manual-closure-timing-report.json": ".phase2-diagnostics/phase2-manual-closure-timing-report.json",
    },
    "phase3": {
        "p2-to-p3-contamination-report.json": ".phase3-evidence/p2-to-p3-contamination-report.json",
        "p2-to-p3-source-admission-report.json": ".phase3-evidence/p2-to-p3-source-admission-report.json",
        "phase-3-output-contamination-report.json": ".phase3-evidence/phase-3-output-contamination-report.json",
    },
    "phase4": {
        "p3-to-p4-contamination-report.json": ".phase4-contract/p3-to-p4-contamination-report.json",
        "p3-to-p4-source-admission-report.json": ".phase4-contract/p3-to-p4-source-admission-report.json",
        "phase-4-output-contamination-report.json": ".phase4-contract/phase-4-output-contamination-report.json",
